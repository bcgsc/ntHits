...
static const char USAGE_MESSAGE[] =
    ...
    "  -g, --gap=N	use gap seed of size k-N\n"
...
static const struct option longopts[] = {
	...
	{ "hash", required_argument, NULL, 'h' },       { "gap", required_argument, NULL, 'g' },
...
static const unsigned char b2r[256] = { 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 0
	                                    ...
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 11
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 12"CBFilter.hpp"
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 13"CBFilter.hpp"
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 14
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
	                                    'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', // 15
...
main(int argc, char** argv)
{
	...
	cerr << "checkpoint1"
	     << "\n";
	if (opt::dbfSize % 8 != 0) {
		opt::dbfSize = opt::dbfSize + (8 - (opt::dbfSize % 8));
	}
	...
	if (opt::outbloom) {
		if (opt::hitSize % 8 != 0) {
			opt::hitSize = opt::hitSize + (8 - (opt::hitSize % 8));
		}
